...
- **Margins are sacred.** Nothing renders in the margin zone. Footers are set via @page margin boxes, or as a fixed-height footer band inside the flow; never absolute-positioned elements floated over content, which collide with the last line of a full page.
