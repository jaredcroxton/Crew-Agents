...
Gate note: the Color 5 / Slop 1 pass (crew-design-patterns at plan time, crew-design-quality at the gate) must scrutinise this preset specifically. If the rendered deck reads as generic blue-on-black dark SaaS, revise before ship.
