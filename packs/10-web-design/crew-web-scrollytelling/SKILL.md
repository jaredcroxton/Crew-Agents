...
- Reference files: `references/playbook.md` (footage law), `references/engine.md` (build recipes), `pipeline/kie.py` (KIE chain runner), `scripts/chain-step.sh`, `scripts/assemble.sh`, `scripts/verify.js`, `reference-build/` (the worked forge storyboard).
