...
**Find the right people and start better conversations.**

From first research to a signed proposal, these skills keep the pipeline moving and the follow-up consistent. They chain: research feeds the brief, the brief feeds outreach, outreach feeds follow-up.

| Skill | Does | Output |
|---|---|---|
| `crew-sales-lead-research` | Finds and verifies useful information about a lead or company | Company summary, pain points, decision-maker notes |
| `crew-sales-prospect-brief` | Turns lead information into a one-glance brief before a call | Prospect profile, opener, objections, next step |
...
Install this pack (Core comes with it): `./install.sh --pack sales`
