...
<p align="center">
  <img src="https://img.shields.io/badge/CREW-v1.16.0-333333?style=for-the-badge&labelColor=000000&color=333333" alt="CREW v1.16.0">
  <img src="https://img.shields.io/badge/SKILLS-107-333333?style=for-the-badge&labelColor=lime&color=333333" alt="107 Skills">
...
> **The only agent skill pack with a built-in brand context system.** 107 gold-standard skills. 14 packs. Every business function covered. Onboard your business once, and every skill knows your brand, your voice, and your audience.

---

## What CREW is

CREW gives your AI agents the skills to operate as a full business team. Not one agent with surface-level knowledge: 107 specialised skills that know their domain, reference each other, and produce premium output with built-in quality gates.
...
| Brand context persists across all 107 skills | Each skill is an island, no shared knowledge |
...
**QA smoke suite:** `bash shared/qa-check.sh --smoke` invokes the Claude CLI roughly once per skill (about 107 metered calls on the full catalogue). Use `--pack <id>` to narrow it. The structural pass (`bash shared/qa-check.sh`) is free.
...
| 03 | Marketing | 8 | Campaigns, brand voice, content, SEO, social |
...
| **0 em dashes** | Strict white-label discipline across all 107 skills |
...
Alongside the 107 Crew skills, the install ships six [HyperFrames](https://github.com/heygen-com/hyperframes) skills, the HTML-to-video engine ("Write HTML. Render video. Built for agents."). Invoke `hyperframes` when you want a rendered video: compositions, captions synced to audio, text-to-speech voiceover, audio-reactive motion, hand-drawn emphasis effects, shader transitions, and full renders via `npx hyperframes` (needs Node 18+).
